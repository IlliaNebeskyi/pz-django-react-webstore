...
from app.views.auction import UserAuctionsView, AddAuctionView, EditAuctionView, BuyView, CancelAuctionView
...
urlpatterns = [
    ...
    path('api/auctions/<int:user_id>', UserAuctionsView.as_view(), name='user-auctions'),
